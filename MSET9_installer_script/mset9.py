...
print(r"   __     ___                _                         __   _   _                                 _                _")
print(r"  |  |   |_ _|_ _  _ __ _  _| |_   ___ _ _  ___   ___ / _| | |_| |_  ___ ___ ___   _ _ _  _ _ __ | |__  ___ _ _ __| |")
print(r"  |  |    | || ' \| '_ \ || |  _| / _ \ ' \/ -_) / _ \  _| |  _| ' \/ -_|_-</ -_) | ' \ || | '  \| '_ \/ -_) '_(_-<_|")
print(r"  |  |   |___|_||_| .__/\_,_|\__| \___/_||_\___| \___/_|    \__|_||_\___/__/\___| |_||_\_,_|_|_|_|_.__/\___|_| /__(_)")
print(r"__|  |__          |_|")
print(r"\      /")
print(r" \    /")
print(r"  \  /")
